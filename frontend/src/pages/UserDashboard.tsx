    ...
    <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '40px 24px' }}>
      ...
      <div style={{ display: 'flex', gap: '16px', marginBottom: '3rem' }}>
        ...
        <button 
          ...
          onClick={() => { setActiveTab('portal'); handleCloseRack(); }}
        >
